...
var require_acorn = __commonJS({
  "node_modules/acorn/dist/acorn.js"(exports, module2) {
    (function(global2, factory) {
      ...
      pp$8.parseStatement = function(context2, topLevel, exports3) {
...
var require_espree = __commonJS({
  "node_modules/espree/dist/espree.cjs"(exports) {
    ...
    function convertTemplatePart(tokens, code) {
      ...
      if (firstToken.range) {
        token2.start = firstToken.range[0];
        token2.end = lastTemplateToken.range[1];
        token2.range = [token2.start, token2.end];
      }
      return token2;
    }
    ...
    TokenTranslator.prototype = {
      ...
      translate(token2, extra) {
        const type = token2.type, tt = this._acornTokTypes;
        if (type === tt.name) {
          token2.type = Token.Identifier;
          if (token2.value === "static") {
            token2.type = Token.Keyword;
          }
          if (extra.ecmaVersion > 5 && (token2.value === "yield" || token2.value === "let")) {
            token2.type = Token.Keyword;
          }
        } else if (type === tt.privateId) {
          token2.type = Token.PrivateIdentifier;
          ...
          token2.value = this._code.slice(token2.start, token2.end);
        } else if (type === tt.jsxName) {
          token2.type = Token.JSXIdentifier;
        } else if (type.label === "jsxText" || type === tt.jsxAttrValueToken) {
          token2.type = Token.JSXText;
        } else if (type.keyword) {
          if (type.keyword === "true" || type.keyword === "false") {
            token2.type = Token.Boolean;
          } else if (type.keyword === "null") {
            token2.type = Token.Null;
          } else {
            token2.type = Token.Keyword;
          }
        } else if (type === tt.num) {
          token2.type = Token.Numeric;
          token2.value = this._code.slice(token2.start, token2.end);
          ...
          if (extra.jsxAttrValueToken) {
            ...
            token2.type = Token.String;
          }
          token2.value = this._code.slice(token2.start, token2.end);
        } else if (type === tt.regexp) {
          token2.type = Token.RegularExpression;
          const value = token2.value;
          token2.regex = {
            flags: value.flags,
            pattern: value.pattern
          };
          token2.value = `/${value.pattern}/${value.flags}`;
        }
        return token2;
      },
      onToken(token2, extra) {
        const that = this, tt = this._acornTokTypes, tokens = extra.tokens, templateTokens = this._tokens;
        function translateTemplateTokens() {
          tokens.push(convertTemplatePart(that._tokens, that._code));
          that._tokens = [];
        }
        if (token2.type === tt.eof) {
          if (this._curlyBrace) {
            tokens.push(this.translate(this._curlyBrace, extra));
          }
          return;
        }
        if (token2.type === tt.backQuote) {
          if (this._curlyBrace) {
            tokens.push(this.translate(this._curlyBrace, extra));
            this._curlyBrace = null;
          }
        ...
        if (token2.type === tt.dollarBraceL) {
          templateTokens.push(token2);
          translateTemplateTokens();
          return;
        }
        if (token2.type === tt.braceR) {
          if (this._curlyBrace) {
            tokens.push(this.translate(this._curlyBrace, extra));
          }
          this._curlyBrace = token2;
          return;
        }
        if (token2.type === tt.template || token2.type === tt.invalidTemplate) {
          if (this._curlyBrace) {
        ...
        tokens.push(this.translate(token2, extra));
      }
    };
      ...
      return class Espree extends Parser {
        constructor(opts, code) {
          ...
          super({
            ...
            onToken: (token2) => {
              if (tokenTranslator) {
                tokenTranslator.onToken(token2, this[STATE]);
              }
              if (token2.type !== tokTypes.eof) {
                this[STATE].lastToken = token2;
              }
            },
...
// node_modules/@adryd325/discord-datamining-lang-differ/getLangStrings.js
var require_getLangStrings = __commonJS({
  "node_modules/@adryd325/discord-datamining-lang-differ/getLangStrings.js"(exports, module2) {
    var espree = require_espree();
    module2.exports = getLangStrings;
    function getLangStrings(file) {
      ...
      webpackModules.forEach((webpackChunk) => {
        var _a;
        (_a = webpackChunk == null ? void 0 : webpackChunk.properties) == null ? void 0 : _a.forEach((webpackModule) => {
          var _a2, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v;
          if (((_h = (_g = (_f = (_e = (_d = (_c = (_b = (_a2 = webpackModule == null ? void 0 : webpackModule.value) == null ? void 0 : _a2.body) == null ? void 0 : _b.body) == null ? void 0 : _c[1]) == null ? void 0 : _d.expression) == null ? void 0 : _e.right) == null ? void 0 : _f.callee) == null ? void 0 : _g.object) == null ? void 0 : _h.name) === "Object" && ((_p = (_o = (_n = (_m = (_l = (_k = (_j = (_i = webpackModule == null ? void 0 : webpackModule.value) == null ? void 0 : _i.body) == null ? void 0 : _j.body) == null ? void 0 : _k[1]) == null ? void 0 : _l.expression) == null ? void 0 : _m.right) == null ? void 0 : _n.callee) == null ? void 0 : _o.property) == null ? void 0 : _p.name) === "freeze" && ((_v = (_u = (_t = (_s = (_r = (_q = webpackModule == null ? void 0 : webpackModule.value) == null ? void 0 : _q.body) == null ? void 0 : _r.body) == null ? void 0 : _s[1]) == null ? void 0 : _t.expression) == null ? void 0 : _u.right) == null ? void 0 : _v.arguments[0])) {
            if (webpackModule.value.body.body[1].expression.right.arguments[0].properties.some((suspectedLangModule) => {
              if (suspectedLangModule.key.name === "DISCORD_NAME" || suspectedLangModule.key.name === "TEAL") {
                return true;
              }
            })) {
              webpackModule.value.body.body[1].expression.right.arguments[0].properties.forEach((langEntry) => {
...
// node_modules/@adryd325/discord-datamining-lang-differ/differ.js
var require_differ = __commonJS({
  "node_modules/@adryd325/discord-datamining-lang-differ/differ.js"(exports, module2) {
    var getLangStrings = require_getLangStrings();
    var formats = {
      "codeblock": {
        startString: "## Strings\n```diff",
        endString: "```",
...
`
    ...
    module2.exports = doWork;
  }
});

// node_modules/hyttpo/dist/js/util/utils.js
var require_utils5 = __commonJS({
  "node_modules/hyttpo/dist/js/util/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = void 0;
    var ignoreHeaders = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"];
    var Util = class {
      static isJSON(data) {
        if (typeof data !== "string")
          return false;
      ...
      static parseHeaders(headers) {
        ...
        headers.split("\n").forEach((line) => {
          ...
          if (key) {
            if (parsed[key] && ignoreHeaders.indexOf(key) >= 0)
              return;
            if (key === "set-cookie")
...
// node_modules/hyttpo/dist/js/structures/Response.js
var require_Response = __commonJS({
  "node_modules/hyttpo/dist/js/structures/Response.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Response = class {
      constructor(options) {
        ...
        if ("statusMessage" in options)
          this.statusText = options.statusMessage;
        if ("headers" in options)
          this.headers = options.headers;
        if ("data" in options)
          this.data = options.data;
        if ("responseUrl" in options)
...
// node_modules/hyttpo/dist/js/structures/HPromise.js
var require_HPromise = __commonJS({
  "node_modules/hyttpo/dist/js/structures/HPromise.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.HPromise = void 0;
    ...
    var HPromise = class extends Promise {
    ...
    exports.HPromise = HPromise;
  }
});

// node_modules/hyttpo/dist/js/adapters/node/httpAdapter.js
var require_httpAdapter = __commonJS({
  "node_modules/hyttpo/dist/js/adapters/node/httpAdapter.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.httpAdapter = void 0;
    var https = _interopRequireWildcard(require("https"));
    var http = _interopRequireWildcard(require("http"));
    var follwoRedirects = _interopRequireWildcard(require_follow_redirects());
    var zlib = _interopRequireWildcard(require("zlib"));
    var _buffer = require("buffer");
    var _utils = _interopRequireDefault(require_utils5());
    var _Response = require_Response();
    var _HPromise = require_HPromise();
    ...
    var httpAdapter = (data, methods) => {
      var _a;
      let resolves;
      let rejects;
      const promise = new _HPromise.HPromise((resolve, reject) => {
        resolves = resolve;
        rejects = reject;
      });
      ...
      const headers = data.headers ? _utils.default.stringsToLowerCase(data.headers) : {};
      if (!headers.accept)
        headers.accept = "application/json, text/plain, */*";
      if (!headers["user-agent"])
        headers["user-agent"] = "hyttpo/nodejs (+https://github.com/Garlic-Team/hyttpo)";
      if (methods.includes(method) && method !== "GET")
        request = request.request;
      else
        request = request[method.toLowerCase()];
      ...
      if (data.maxBodyLength > -1)
        requestOptions.maxBodyLength = data.maxBodyLength;
      const req = request(requestOptions, (res) => {
        ...
        const response = new _Response.Response({ request: res, statusCode: res.statusCode, statusMessage: res.statusMessage, headers: res.headers });
        ...
        if (data.responseType === "stream") {
          stream.on("data", (chunk) => {
            ...
            (_a2 = data.onData) == null ? void 0 : _a2.call(data, chunk);
          });
          stream.on("end", () => {
            var _a2;
            promise.emit("end", stream);
            (_a2 = data.onEnd) == null ? void 0 : _a2.call(data, stream);
          });
          ...
          stream.on("data", (chunk) => {
            ...
            if (data.maxContentLength > -1 && Buffer.concat(buffer).length > data.maxContentLength) {
              stream.destroy();
              (_b = data.onError) == null ? void 0 : _b.call(data, `maxContentLength (${data.maxContentLength}) exceeded`);
          ...
          stream.on("error", (error) => {
            ...
            if (req.aborted)
              return;
            (_a2 = data.onError) == null ? void 0 : _a2.call(data, error);
          ...
          stream.on("end", () => {
            ...
            if (!["arraybuffer", "buffer"].includes(data.responseType)) {
              buffer = _utils.default.responseRefactor(buffer, data.responseEncoding);
              if (data.responseType === "blob")
                buffer = new _buffer.Blob([_utils.default.toString(buffer)]);
            } else if (data.responseType === "arraybuffer") {
              buffer = _utils.default.toArrayBuffer(buffer);
            }
            response.data = buffer;
            (_a2 = data.onEnd) == null ? void 0 : _a2.call(data, { buffer, response });
      ...
      req.on("error", (error) => {
        var _a2;
        if (req.aborted && error.code !== "ERR_FR_TOO_MANY_REDIRECTS")
          return;
        (_a2 = data.onError) == null ? void 0 : _a2.call(data, error);
        promise.emit("error", error);
        rejects(error);
      ...
      req.on("response", (message) => {
        var _a2;
        promise.emit("response", new _Response.Response(message));
        (_a2 = data.onResponse) == null ? void 0 : _a2.call(data, new _Response.Response(message));
      });
      if (body && method !== "GET") {
        if (_utils.default.isObject(body) && (((_a = body == null ? void 0 : body.constructor) == null ? void 0 : _a.name) === "FormData" || _utils.default.isStream(body))) {
          body.pipe(req);
        } else {
          req.write(body);
          req.end();
...
// node_modules/hyttpo/dist/js/adapters/browser/xmlAdapter.js
var require_xmlAdapter = __commonJS({
  "node_modules/hyttpo/dist/js/adapters/browser/xmlAdapter.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.xmlAdapter = void 0;
    var _Response = require_Response();
    var _HPromise = require_HPromise();
    var _utils = _interopRequireDefault(require_utils5());
    function _interopRequireDefault(obj) {
    ...
    var xmlAdapter = (data) => {
      ...
      if (_utils.default.isFormData(body))
      ...
      const onLoadEnd = () => {
        ...
        if (!headers.accept)
          headers.accept = "application/json, text/plain, */*";
        if (!headers["user-agent"])
          headers["user-agent"] = "hyttpo/XMLHttp (+https://github.com/Garlic-Team/hyttpo)";
        const responseHeaders = "getAllResponseHeaders" in request ? _utils.default.parseHeaders(request.getAllResponseHeaders()) : null;
        let responseData = !data.responseType || data.responseType === "text" || data.responseType === "json" ? request.responseText : request.response;
        if (!["arraybuffer", "buffer"].includes(data.responseType))
          responseData = _utils.default.responseRefactor(responseData, data.responseEncoding);
        const response = new _Response.Response({ request, statusCode: request.status, statusMessage: request.statusText, headers: responseHeaders, responseUrl: request.responseURL, data: responseData });
        (_a = data.onEnd) == null ? void 0 : _a.call(data, { response });
      ...
      request.onloadstart = (event) => {
        ...
        (_a = data.onResponse) == null ? void 0 : _a.call(data, event);
      };
      request.onprogress = (event) => {
        var _a;
        promise.emit("downloadProgress", event);
        (_a = data.onDownloadProgress) == null ? void 0 : _a.call(data, event);
      };
      request.upload.onprogress = (event) => {
        var _a;
        promise.emit("uploadProgress", event);
        (_a = data.onUploadProgress) == null ? void 0 : _a.call(data, event);
      };
      request.onabort = () => {
        var _a;
        if (!request)
        ...
        (_a = data.onError) == null ? void 0 : _a.call(data, "Request aborted");
      ...
      request.onerror = () => {
        ...
        (_a = data.onError) == null ? void 0 : _a.call(data, "Network Error");
      ...
      request.ontimeout = () => {
        ...
        (_a = data.onError) == null ? void 0 : _a.call(data, "Request timeouted");
      ...
      if (data.responseType && data.responseType.toLowerCase() !== "json")
        request.responseType = data.responseType.toLowerCase();
      request.send(body);
      return promise;
    };
    exports.xmlAdapter = xmlAdapter;
  }
});

// node_modules/hyttpo/dist/js/base/hyttpo.js
var require_hyttpo = __commonJS({
  "node_modules/hyttpo/dist/js/base/hyttpo.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Hyttpo = void 0;
    var _utils = _interopRequireDefault(require_utils5());
    var _httpAdapter = require_httpAdapter();
    var _xmlAdapter = require_xmlAdapter();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var methods = ["GET", "POST", "PATCH", "PUT", "TRACE", "HEAD", "OPTIONS", "CONNECT", "DELETE", "SEARCH", "PURGE", "LINK", "UNLINK"];
    var Hyttpo = class {
      constructor() {
        methods.forEach((method) => {
          this[method.toLocaleLowerCase()] = (url, data = {}) => {
            ...
            if (!data.url)
              data.url = url;
            return this.rawRequest(__spreadValues({ method }, data));
          };
        });
      }
      request(data) {
      ...
      rawRequest(data) {
        data = _utils.default.dataConfigParse(data);
        if (typeof XMLHttpRequest !== "undefined") {
          return (0, _xmlAdapter.xmlAdapter)(data);
        } else {
          return (0, _httpAdapter.httpAdapter)(data, methods);
        }
      }
      get(url, data) {
      }
    ...
    exports.Hyttpo = Hyttpo;
  }
});

// node_modules/hyttpo/dist/js/util/constants.js
var require_constants = __commonJS({
  "node_modules/hyttpo/dist/js/util/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/hyttpo/dist/js/index.js
var require_js = __commonJS({
  "node_modules/hyttpo/dist/js/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var _exportNames = { hyttpo: true };
    exports.hyttpo = exports.default = void 0;
    var _hyttpo = require_hyttpo();
    Object.keys(_hyttpo).forEach(function(key) {
      if (key === "default" || key === "__esModule")
        return;
      if (Object.prototype.hasOwnProperty.call(_exportNames, key))
        return;
      if (key in exports && exports[key] === _hyttpo[key])
        return;
    ...
    Object.keys(_Response).forEach(function(key) {
      ...
      if (Object.prototype.hasOwnProperty.call(_exportNames, key))
        return;
      if (key in exports && exports[key] === _Response[key])
        return;
      Object.defineProperty(exports, key, { enumerable: true, get: function() {
    ...
    var _HPromise = require_HPromise();
    Object.keys(_HPromise).forEach(function(key) {
      if (key === "default" || key === "__esModule")
        return;
      if (Object.prototype.hasOwnProperty.call(_exportNames, key))
        return;
      if (key in exports && exports[key] === _HPromise[key])
        return;
      Object.defineProperty(exports, key, { enumerable: true, get: function() {
        return _HPromise[key];
      } });
    });
    ...
    var _xmlAdapter = require_xmlAdapter();
    Object.keys(_xmlAdapter).forEach(function(key) {
      if (key === "default" || key === "__esModule")
        return;
      if (Object.prototype.hasOwnProperty.call(_exportNames, key))
        return;
      if (key in exports && exports[key] === _xmlAdapter[key])
        return;
      Object.defineProperty(exports, key, { enumerable: true, get: function() {
        return _xmlAdapter[key];
      } });
    });
    var _httpAdapter = require_httpAdapter();
    Object.keys(_httpAdapter).forEach(function(key) {
      if (key === "default" || key === "__esModule")
        return;
      if (Object.prototype.hasOwnProperty.call(_exportNames, key))
        return;
      if (key in exports && exports[key] === _httpAdapter[key])
        return;
      Object.defineProperty(exports, key, { enumerable: true, get: function() {
        return _httpAdapter[key];
      } });
    });
    var hyttpo2 = new _hyttpo.Hyttpo();
    exports.hyttpo = hyttpo2;
    var _default = hyttpo2;
    exports.default = _default;
  }
});
...
var differ = require_differ();
var hyttpo = require_js().default;
var token = process.env.GITHUB_TOKEN;
var discordwebhook = process.env.DISCORD_WEBHOOK;
var filePathRegex = /\/\d{4}\/(?:\d{4}-\d{2}-\d{2}|\d{2}\/\d{2})\/[a-z0-9]{20,}\.js$/;
var currentFilename = "current.js";
async function run() {
  try {
    if (!token)
      return core.setFailed("Invalid GITHUB_TOKEN");
    ...
    let diff;
    try {
      diff = differ(currentContent, newContent, "codeblock");
    } catch (e) {
